...
---@class RecordingDevice : LoveObject
...
---@param fx number @The x position of forward vector of the listener orientation.
---@param fy number @The y position of forward vector of the listener orientation.
---@param fz number @The z position of forward vector of the listener orientation.
---@param ux number @The x position of up vector of the listener orientation.
---@param uy number @The y position of up vector of the listener orientation.
---@param uz number @The z position of up vector of the listener orientation.
